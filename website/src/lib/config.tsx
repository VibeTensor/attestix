...
export const siteConfig = {
  ...
  // The rendered fields on the public site are: event, text (quote), name,
  // role, company, venue. Other fields are kept brief and non-strategic so
  // that if GitHub scrapes this config, no internal GTM context leaks.
  highlights: [
    {
      id: 1,
