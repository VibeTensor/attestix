...
> "Issue a verifiable credential certifying this agent is EU AI Act compliant"

This calls `issue_credential` with Ed25519Signature2020 signing, producing a full W3C Verifiable Credential.
...
That is it. Five steps, five minutes, and your AI agent now has verifiable identity and compliance credentials.
