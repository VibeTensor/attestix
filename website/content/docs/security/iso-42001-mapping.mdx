...
The table below covers 14 representative rows spanning **28 of the 38 Annex A controls** plus the AIMS process clauses (Clauses 4 to 10). The complete control inventory and ratings are in the [internal mapping doc](#see-also).
