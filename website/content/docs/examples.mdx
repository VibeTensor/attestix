...
Runnable examples for every Attestix module. All examples work standalone after `pip install attestix` (stable 0.4.1).

Stable 0.4.1 ships the canonical `attestix.*` namespace shown below. The older
