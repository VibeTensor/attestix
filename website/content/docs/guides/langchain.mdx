...
description: Drop Attestix into a LangChain agent with the BaseCallbackHandler. Real (not example) integration shipped in v0.3.0; v0.4.0-rc.2 release candidate. Every tool call, LLM call, and chain step gets hash-chained and signed.
---
